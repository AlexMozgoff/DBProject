...
<div class="center label textCenter">Update Client</div>
...
<form action="update" method="get" class="center">
    ...
    <div class="regTextboxes">
        ...
        <div class="field">
            ...
            <input class="input" name="city" value="<%=Logic.replaceSpace(request.getParameter("city"))%>"/>
        </div>
        ...
        <div class="field">
            ...
            <input class="input" name="phone" value="<%=Logic.replaceSpace(request.getParameter("phone"))%>"/>
        </div>

        <div class="hidden">
            <label></label>
            <input name="clientId" value="<%=Integer.parseInt(request.getAttribute("clientId").toString())%>"/>
