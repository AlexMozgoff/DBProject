...
<div class="center label textCenter">Update car sell agreement</div>
...
<form action="update" method="get" class="center">
    ...
    <div class="regTextboxes">
        ...
        <div class="field">
            ...
            <input class="input" name="clientId" value="<%=Logic.replaceSpace(request.getParameter("clientId"))%>" pattern="^[0-9]+$"/>
        </div>
