...
<div class="center label textCenter">Add car sell agreement</div>

<form action="addcarsellagreement" method="get" class="center">
    ...
    <div class="regTextboxes">
        ...
        <div class="field">
            ...
            <input class="input" name="commission"/>
        </div>
    ...
    <div class="hidden" name="map"><%=request.getAttribute("cars")%></div>
</form>
